...
if activity == "Activity 1 - Data Exploration":
    ...
    with col1:
        ...
        st.write(f"**Data Summary:** The dataset contains {counts[0]} survival cases and {counts[1]} death cases. This demonstrates the class imbalance discussed in the module.")
...
# --- ACTIVITY 2: RANDOM FOREST TRAINING ---
    ...
    n_estimators = st.sidebar.slider("Number of Trees", 100, 1000, 500, step=100, help="Matches the default in the notebook.")
...
# --- ACTIVITY 3: TREE VS FOREST COMPARISON ---
    ...
    st.write("Adjust parameters for both models to investigate why an ensemble approach is often preferred over a single tree.")
    ...
    if st.button("Compare Models"):
        ...
        st.write(f"**Data Summary:** Using the current settings, the Decision Tree achieved {dt_acc:.1%} accuracy and the Random Forest achieved {rf_acc:.1%}.")
    ...
    st.write("Which one performs better, random forest or decision tree? Use the metrics generated in these activities to justify your answer in your Canvas submission.")
